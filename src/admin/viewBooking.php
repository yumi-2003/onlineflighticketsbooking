...
try {
   $sql = "SELECT booking.booking_id,users.username,flight.flight_name,classes.class_name,triptype.triptype_name,seat_layout.seatNo,booking.bookAt,booking.status FROM booking 
            ...
            <table class="min-w-full bg-white">
               ...
               <tbody class="whitespace-nowrap">
                  ...
                  if (isset($bookings)) {
                    ...
                    <a href='deleteBooking.php?bid=$booking[booking_id]'>
