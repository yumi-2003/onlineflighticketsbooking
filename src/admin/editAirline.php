        ...
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-1">
            <input type="hidden" name="airline_id"
                value="<?php
                        ...
                        ?>">
            <div>
                <label for="airlineName" class="block mb-2 text-sm font-medium dark:text-black dark:text-black">Airline Name</label>
            ...
            <label for="uploadFile"
                ...
                <p class="text-gray-400 font-semibold text-sm">Drag & Drop or<br>
                    <span class="text-[#007bff]">Choose Airline Photo</span>
                </p>
