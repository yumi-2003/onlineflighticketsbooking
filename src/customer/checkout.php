...
<body>
    ...
    <div id="paymentForm" class="block mt-24 px-4 sm:px-6 lg:px-8">
    <!-- Stepper -->
    <ol class="flex items-center w-full text-sm font-medium text-gray-500 sm:text-base">
        <!-- Step 1: Flight Information -->
        <li class="flex md:w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:inline-block after:mx-4 xl:after:mx-8">
            <div class="flex items-center whitespace-nowrap">
                <span class="w-6 h-6 bg-indigo-600 border border-indigo-200 rounded-full flex justify-center items-center mr-3 text-sm text-white lg:w-10 lg:h-10">1</span>
                <span class="hidden sm:inline">Flight Information</span>
            </div>
        </li>
        ...
        <li class="flex md:w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:inline-block after:mx-4 xl:after:mx-8">
            <div class="flex items-center whitespace-nowrap">
                <span class="w-6 h-6 bg-indigo-600 border border-indigo-200 rounded-full flex justify-center items-center mr-3 text-sm text-white lg:w-10 lg:h-10">2</span>
                <span class="hidden sm:inline">Personal Information</span>
            </div>
        </li>

        <!-- Step 3: Payment (Active Step) -->
        <li class="flex items-center">
            <div class="flex items-center whitespace-nowrap">
                <span class="w-6 h-6 bg-indigo-600 border border-indigo-200 rounded-full flex justify-center items-center mr-3 text-sm text-white lg:w-10 lg:h-10">3</span>
    ...
    <div class="font-[sans-serif] bg-white p-4 mx-auto max-w-6xl">
        <div class="p-6 rounded-md border-2 shadow-lg">
            <h2 class="text-3xl font-extrabold text-gray-800 text-center">Checkout</h2>

            <div class="mt-8 flex flex-col lg:flex-row gap-8">
                <!-- Price Summary Section -->
                <div class="lg:w-1/2 bg-white p-6 rounded-md shadow-sm">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Summary</h3>
                    <ul class="text-gray-800 space-y-3">
                        <li class="flex justify-between text-sm">
                            <span>Flight Base Fees</span>
                            <span class="font-bold">$<?php echo $flight['fee_per_ticket'] ?? ''; ?></span>
                        </li>
                        <li class="flex justify-between text-sm">
                            <span>Class Type Charges</span>
                            <span class="font-bold">$<?php echo $flight['base_fees'] ?? ''; ?></span>
                        </li>
                        <li class="flex justify-between text-sm">
                            <span>Trip Type Charges</span>
                            <span class="font-bold">$<?php echo $flight['priceCharge']; ?></span>
                        </li>
                        <li class="flex justify-between text-sm">
                            <span>Tax</span>
                            <span class="font-bold">$<?php echo number_format(0.15, 2); ?></span>
                        </li>
                        <hr class="my-2">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="mt-6">
                        ...
                        <div class="flex border border-blue-600 overflow-hidden rounded-lg max-w-md">
                            ...
                            <button type="submit" name="applyCode"
                    ...
                    <p class="text-sm text-gray-600 mt-4">
                        Additional fees like baggage fee are calculated in tax.
                    </p>
                </div>

                <!-- Payment Form Section -->
                <div class="lg:w-1/2 bg-white p-6 rounded-md shadow-sm">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Payment Details</h3>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <input type="text" placeholder="Name of card holder" name="name"
                                    class="px-4 py-3.5 bg-white text-gray-800 w-full text-sm border rounded-md focus:border-blue-600 outline-none" />
                                <input type="text" placeholder="CVV" name="securityCode"
                                    class="px-4 py-3.5 bg-white text-gray-800 w-full text-sm border rounded-md focus:border-blue-600 outline-none" />
                                <input type="text" placeholder="Card number" name="cardNo"
                                    class="col-span-full px-4 py-3.5 bg-white text-gray-800 w-full text-sm border rounded-md focus:border-blue-600 outline-none" />
                            ...
                            <div class="flex flex-wrap gap-4 mt-8">
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                    ...
                                    <button type="submit" name="addToCart"
                                        class="px-7 py-3.5 text-sm tracking-wide bg-white hover:bg-gray-50 text-gray-800 rounded-md border border-gray-300">Pay later</button>
                                </form>
