...
<body class="bg-[#f2f1ef]">
  ...
  <div class='flex h-auto items-center justify-center'>
    ...
    if (isset($_POST['find'])) {
      ...
      // If no search is performed, show all flights.
      try {
    ...
    if (!empty($flights)) {
      ...
      // Show "No Flights Available" message if no flights match the search criteria
      echo "<div class='text-center mt-10'>
        <img src='/images/noflight.png' class='w-28 h-28 mx-auto' />
        <span class='text-base block mt-4'>No Flights Available</span>
    </div>";
    }
    ?>
  </div>
