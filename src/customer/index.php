        ...
        <nav class= "fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
                ...
                <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <!-- <a href="cLogin.php" class="hidden md:inline-block px-4 py-2 text-sm text-white bg-blue-600 hover:bg-blue-700 rounded-md">Login</a>
                    <a href="cSignUp.php" class="hidden md:inline-block px-4 py-2 text-sm text-white bg-blue-600 hover:bg-blue-700 rounded-md">Sign Up</a> -->
