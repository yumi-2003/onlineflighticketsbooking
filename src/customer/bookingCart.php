...
$flight_name = $_SESSION['flight_name'] ?? null;
$class_id = $_SESSION['class_id'] ?? null;
$class_name = $_SESSION['class_name'] ?? null;
$triptypeId = $_SESSION['triptypeId'] ?? null;
$triptype_name = $_SESSION['triptype_name'] ?? null;
$selectedSeats = $_SESSION['selectedSeats'] ?? [];
$total_price = $_SESSION['total_price'] ?? 0;
$flight_date = $_SESSION['flight_date'] ?? null;

// Display session data (example)
// echo "Flight ID: $flight_id<br>";
// echo "Flight Name: $flight_name<br>";
// echo "Class ID: $class_id<br>";
// echo "Class Name: $class_name<br>";
// echo "Trip Type ID: $triptypeId<br>";
// echo "Trip Type Name: $triptype_name<br>";
// echo "Selected Seats:<br>";
// foreach ($selectedSeats as $seatId => $seatNo) {
//     echo "Seat ID: $seatId, Seat Number: $seatNo<br>";
// }
...
<body>
    ...
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto my-24">
        <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Flight Information</h5>
        <!-- <div class="flex items-baseline text-gray-900 dark:text-white">
            <span class="text-3xl font-semibold">Flight Name:</span>
        ...
        <ul role="list" class="space-y-5 my-7">
            <li class="flex items-center">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Flight Name: <?php
                echo $flight_name;
                ?>
            </span>
            </li>
            <li class="flex">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Class Type:
                    <?php
                        echo $class_name;
                    ?>
                </span>
            ...
            <li class="flex">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Trip Type:
                    <?php
                        echo $triptype_name;
                    ?>
                </span>
            ...
            <li class="flex">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Seat no:
                    <?php
                         foreach ($selectedSeats as $seatId => $seatNo) {
                             echo  $seatNo;
                         }
            ...
            <li class="flex">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Departure Date:
                    <?php
                        echo $flight_date;
                    ?>
                </span>
            ...
            <li class="flex">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Total Price:
                    $<?php
                        echo $total_price;
                    ?>
                </span>
        ...
        <a href="checkout.php">
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Make Payment</button>
        </a>
    </div>
