...
<body>
    ...
    <div class="p-6 border border-gray-200 dark:border-gray-700 bg-white shadow-lg rounded-lg w-auto max-w-3xl mx-auto my-24">
        <h6 class="text-center text-3xl font-bold">View Tickets</h6>
        <?php
        if (isset($tickets)) {
            foreach ($tickets as $ticket) {
                echo "
            <div class='bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden mb-4'>
                <!-- Airline Header -->
                <div class='bg-blue-800 p-4 text-center'>
                    <p class='text-xl font-bold text-white'>{$ticket['flight_name']}</p>
                </div>
                ...
                <div class='p-6 flex flex-col md:flex-row justify-between items-start'>
                    ...
                    <div class='flex-1 mb-4 md:mb-0 md:mr-6'>
                        <div class='mb-4'>
                            ...
                            <p class='text-lg font-bold text-gray-800'>{$ticket['fullName']}</p>
                        </div>
                        <div class='mb-4'>
                            <p class='text-sm text-gray-500'>FROM</p>
                            <p class='text-lg font-bold text-gray-800'>{$ticket['source']}</p>
                        </div>
                        <div>
                            <p class='text-sm text-gray-500'>TO</p>
                            <p class='text-lg font-bold text-gray-800'>{$ticket['destination']}</p>
                        </div>
                    </div>

                    <!-- Middle Section: Flight Details -->
                    <div class='flex-1 mb-4 md:mb-0 md:mx-6'>
                        <div class='mb-4'>
                            <p class='text-sm text-gray-500'>SEAT</p>
                            <p class='text-lg font-bold text-gray-800'>{$ticket['seatNo']}</p>
                        </div>
                        <div class='mb-4'>
                            <p class='text-sm text-gray-500'>GATE</p>
                            <p class='text-lg font-bold text-gray-800'>{$ticket['gate']}</p>
                        </div>
                        <div>
                            <p class='text-sm text-gray-500'>DATE</p>
                            <p class='text-lg font-bold text-gray-800'>{$ticket['flight_date']}</p>
                        </div>
                    </div>

                    <!-- Right Section: Boarding Time and Instructions -->
                    <div class='flex-1 md:ml-6'>
                        <div class='mb-4'>
                            <p class='text-sm text-gray-500'>ARRIVAL TIME</p>
                            <p class='text-lg font-bold text-gray-800'>{$ticket['arrival_time']}</p>
                        </div>
                        <div class='bg-gray-100 p-3 rounded-lg'>
                            <p class='text-sm text-gray-600 text-center'>PLEASE BE AT BOARDING GATE BEFORE {$ticket['departure_time']}</p>
                        </div>
                    </div>
                </div>
            </div>
