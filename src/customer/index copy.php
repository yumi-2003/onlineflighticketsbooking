  ...
  <nav class="fixed top-0 z-50 w-full bg-[#0463ca]">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
      ...
      <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        ?>
          <a href="clogin.php" class="text-white px-4 py-2 rounded-md bg-blue-600 hover:bg-blue-700">Login</a>
          <a href="cSignUp.php" class="text-white px-4 py-2 rounded-md bg-green-600 hover:bg-green-700">Sign Up</a>
        <?php
        }
        ?>
