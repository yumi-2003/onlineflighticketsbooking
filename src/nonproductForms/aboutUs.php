...
<body>
    ...
    <div class="font-sans bg-gray-100 px-4 py-20">
        <div class="grid lg:grid-cols-2 gap-12 lg:max-w-6xl max-w-2xl mx-auto">
            <div class="text-left">
                <h2 class="text-gray-800 text-3xl font-bold mb-6">Discover Us</h2>
                <p class="mb-4 text-sm text-gray-500">At SwiftMiles, we’re redefining the way you travel by making flight ticket booking faster, easier, and more accessible. Whether you're planning a dream vacation, a business trip, or a quick getaway, our platform is designed to ensure your journey starts stress-free.</p>
                <p class="mb-4 text-sm text-gray-500">With SwiftMiles, you can browse, compare, and book flights from the comfort of your home. Our intuitive system lets you pick your favorite seats, secure the best deals, and enjoy exclusive discounts for loyal travelers.</p>
                <p class="text-sm text-gray-500">What sets us apart? It's our commitment to customer satisfaction and innovation. We’re passionate about simplifying your travel experience, offering transparent pricing, flexible options, and 24/7 support to meet your needs.</p>
                <p class="text-sm text-gray-500">Let SwiftMiles take the hassle out of booking so you can focus on what matters—exploring the world and creating memories. Wherever life takes you, we’re here to help you get there swiftly and confidently.</p>
            </div>
            <div>
                <img src="/images/10096627.jpg" alt="Placeholder Image" class="rounded-lg object-contain w-full h-96" />
            </div>
        </div>
    </div>
